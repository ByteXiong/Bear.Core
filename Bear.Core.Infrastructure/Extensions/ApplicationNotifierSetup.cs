...
public static class ApplicationNotifierSetup
{
    public static void ApplicationStartedNotifier(this WebApplication app)
    {
        ...
        app.Lifetime.ApplicationStarted.Register(() =>
        {
            ...
            ConsoleHelper.WriteLine("\tBear.Core, 目前生态还在建设中,欢迎大家提出问题,作者(Wx: Byte_Xiong)会再接再厉", ConsoleColor.Green);
            ConsoleHelper.WriteLine("\tBear.Core 不仅仅是一个.NET后端框架", ConsoleColor.Green);
