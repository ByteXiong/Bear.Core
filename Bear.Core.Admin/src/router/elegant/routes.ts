    ...
    children: [
      {
        name: 'manage_apis',
        path: '/manage/apis',
        component: 'view.manage_apis',
        meta: {
          title: 'manage_apis',
          i18nKey: 'route.manage_apis'
        }
      },
      {
        name: 'manage_dept',
      ...
      },
      {
        name: 'manage_job',
        path: '/manage/job',
        component: 'view.manage_job',
        meta: {
          title: 'manage_job',
          i18nKey: 'route.manage_job'
        }
      },
      {
        name: 'manage_menu',
      ...
      },
      {
        ...
        children: [
          {
            name: 'manage_role_modules',
            path: '/manage/role/modules',
            component: 'view.manage_role_modules',
            meta: {
              title: 'manage_role_modules',
              i18nKey: 'route.manage_role_modules'
            }
          }
        ]
      },
    ...
    children: [
      {
        name: 'monitor_audit',
        path: '/monitor/audit',
        component: 'view.monitor_audit',
        meta: {
          title: 'monitor_audit',
          i18nKey: 'route.monitor_audit'
        }
      }
    ]
  },
