...
using Bear.Core.Common.MultiLanguage;
using Bear.Core.Common.MultiLanguage.Contract;
...
public static class MultiLanguagesSetup
{
    ...
    /// <returns></returns>
    public static IServiceCollection AddCustomMultiLanguages(this IServiceCollection services,
        Action<LocalizationOption> configureOptions = null)
    {
        ...
        var localizationOption = new LocalizationOption
        {
            ...
            SupportedCultures = ["zh-CN", "en-US", "ja-JP", "fr-FR", "de-DE"] // 默认支持的语言 默认支持的语言
        };
        ...
        Action<LocalizationOption> configureOptions = null)
    {
        ...
        var localizationOption = new LocalizationOption
        {
            ...
            ResourcesPath = "", // 默认资源路径
            DefaultCulture = "zh-CN", // 默认语言
            SupportedCultures = ["zh-CN", "en-US", "ja-JP", "fr-FR", "de-DE"] // 默认支持的语言
        };
        configureOptions?.Invoke(localizationOption);
        ...
        var options = new RequestLocalizationOptions
        {
            DefaultRequestCulture =
                new Microsoft.AspNetCore.Localization.RequestCulture(localizationOption.DefaultCulture),
