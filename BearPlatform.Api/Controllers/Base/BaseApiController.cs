...
namespace BearPlatform.Api.Controllers.Base;
 ...
 * 4. [adminAuthorize(new string[] { "admin", "common" })] 自定义的角色特性鉴权，表示拥有admin common角色标识即可访问
 * 5. [Authorize(Policy = GlobalSwitch.AuthPolicysName)] 自定义策略模式 重写AuthorizationHandler鉴权 配合第四点一起使用
 */
//[TokenFilter]
//[adminAuthorize(new string[] { "admin", "common" })]
