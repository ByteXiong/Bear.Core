...
using BearPlatform.Core.Caches.SqlSugar;
using BearPlatform.Core.ConfigOptions;
using BearPlatform.Core.Serilog;
        ...
        if (entityInfo.EntityValue is BaseEntity<long> baseEntity)
        {
            switch (entityInfo.OperationType)
            {
                case DataFilterType.InsertByObject:
                    {
                        if (baseEntity.CreateTime == DateTime.MinValue.ToUnixTimeStampSecond())
                        {
                            baseEntity.CreateTime = DateTime.Now.ToUnixTimeStampSecond();
                        }
                ...
                case DataFilterType.UpdateByObject:
                    baseEntity.UpdateTime = DateTime.Now.ToUnixTimeStampSecond();
                    break;
            }
                ...
                case DataFilterType.InsertByObject:
                    {
                        ...
                        if (baseEntityNoDataScope.CreateTime == DateTime.MinValue.ToUnixTimeStampSecond())
                        {
                            baseEntityNoDataScope.CreateTime = DateTime.Now.ToUnixTimeStampSecond();
                        }
