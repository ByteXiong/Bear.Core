...
using Bear.Core.Common.IdGenerator.Contract;
using Bear.Core.Common.MultiLanguage.Resources;
using Bear.Core.Core;
using Bear.Core.Core.ConfigOptions;
using Bear.Core.Core.Internal;
using Bear.Core.Core.Mapping;
using Bear.Core.Infrastructure.ActionFilter;
using Bear.Core.Infrastructure.Extensions;
using Bear.Core.Infrastructure.Middleware;
using Mapster;
...
app.UseSwaggerUiMiddleware(provider, () => Assembly.GetExecutingAssembly().GetManifestResourceStream("Bear.Core.Api.index.html"));
