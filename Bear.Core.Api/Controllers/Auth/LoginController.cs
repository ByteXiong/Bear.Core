...
using Bear.Core.IBusiness.Queued;
using Bear.Core.IBusiness.System;
using Bear.Core.Infrastructure.Authentication;
using Bear.Core.Models;
using Bear.Core.Models.Queries.Login;
using Bear.Core.ViewModel.Jwt;
using Microsoft.AspNetCore.Authorization;
using Microsoft.AspNetCore.Http;
using Microsoft.AspNetCore.Mvc;
using IOnlineUserService = Bear.Core.IBusiness.Permission.IOnlineUserService;

namespace Bear.Core.Api.Controllers.Auth;
